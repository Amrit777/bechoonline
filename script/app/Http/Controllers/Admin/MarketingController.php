...
class MarketingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (empty($info)) {
            ...
            $data['whatsapp_shop_page_pretext'] = $request->whatsapp_shop_page_pretext;
            $data['whatsapp_other_page_pretext'] = $request->whatsapp_other_page_pretext;
            $data['whatsapp_enable_status'] = $request->whatsapp_enable_status;
            // amit singh added whatsapp tool
            $info = new Option;
            ...
            // amit singh
            $data['whatsapp_number'] = $request->whatsapp_number ?? $old->whatsapp_number;
            $data['whatsapp_shop_page_pretext'] = $request->whatsapp_shop_page_pretext ?? $old->whatsapp_shop_page_pretext;
            $data['whatsapp_other_page_pretext'] = $request->whatsapp_other_page_pretext ?? $old->whatsapp_other_page_pretext;
            $data['whatsapp_enable_status'] = $request->whatsapp_enable_status ?? $old->whatsapp_enable_status;
            // amit singh added whatsapp tool
        }
