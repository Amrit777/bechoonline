                            ...
                            <div class="bigbag">
                                ...
                                <div class="bigbag-cart-form">
                                    <div class="table-responsive">
                                        <table class="shop_table shop_table_responsive cart bigbag-cart-form__contents"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                ...
                                                @foreach (Cart::content() as $row)
                                                    ...
                                                    <tr class="bigbag-cart-form__cart-item cart_item">
                                                        ...
                                                        <td class="product-thumbnail">
                                                            <a href="{{ url('/product/' . $row->name . '/' . $row->id) }}"><img
                                                                    src="{{ $row->options->preview }}" alt=""
                                                                    height="100"></a>
                                                        </td>
                                                        ...
                                                        <td class="product-subtotal" data-title="Total">
                                                            <span
                                                                class="bigbag-Price-amount amount">{{ amount_format($row->price * $row->qty) }}</span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                <tr>
                                                    <td colspan="12" class="actions">
                                                        ...
                                                        <div class="coupon float-right">
                                                            <form class="basicform_with_reload"
                                                                ...
                                                                action="{{ url('/apply_coupon') }}" method="post">
                                                                @csrf
                                                                ...
                                                                <input type="text" name="code" class="input-text"
                                                                    ...
                                                                    required="">
                                                                <button type="submit"
                                                                    class="button basicbtn">{{ __('Apply coupon') }}
                                                                </button>
                                                            </form>
                                                        </div>
                                ...
                                <tbody>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td data-title="Subtotal"><span
                                                class="bigbag-Price-amount amount">{{ amount_format(Cart::priceTotal()) }}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>{{ __('Discount') }}</th>
                                        <td data-title="Subtotal"><span class="bigbag-Price-amount amount">-
                                                {{ amount_format(Cart::discount()) }}</span></td>
                                    </tr>
                                    ...
                                    <tr class="cart-subtotal">
                                        ...
                                        <th>GST({{ tax() }}%)</th>
                                        <td data-title="Subtotal"><span
                                                class="bigbag-Price-amount amount">{{ amount_format(Cart::tax()) }}</span>
                                        </td>
                                    </tr>
                                    <tr class="cart-subtotal">
                                        <th>{{ __('Subtotal') }}</th>
                                        <td data-title="Subtotal"><span
                                                class="bigbag-Price-amount amount">{{ amount_format(Cart::subtotal()) }}</span>
                                        </td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>{{ __('Total') }}</th>
                                        <td data-title="Total"><strong><span
                                                    class="bigbag-Price-amount amount text-dark">{{ amount_format(Cart::total()) }}</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
