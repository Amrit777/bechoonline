                        ...
                        <div class="pd-detail">
                            ...
                            <div class="u-s-m-b-15">
                                ...
                                <div class="pd-detail__rating gl-rating-style">
                                    ...
                                    <span class="pd-detail__review u-s-m-l-4">
                                        ...
                                        <a data-click-scroll="#view-review"><span class="review_count"></span></a></span>
                                </div>
                            </div>
                            @if ($info->stock->stock_manage == 1 && $info->stock->stock_status == 1)
                                <div>
                                    <div class="pd-detail__inline">
                                        <span class="pd-detail__stock"><b>{{ $info->stock->stock_qty }}</b>
                                            {{ __('in stock') }}</span>
                            ...
                            <div class="u-s-m-b-15">
                                <form method="post" class="pd-detail__form cart-form" action="{{ url('/addtocart') }}">
                                        ...
                                        @foreach ($variations as $key => $item)
                                            ...
                                            <div class="pd-detail__color">
                                                ...
                                                @foreach ($item as $k => $row)
                                                    <div class="radio-box">
                                                        <input type="radio" @if ($k == 0) checked @endif
                                                            id="attr{{ $row->variation->id }}"
                                                ...
                                                @foreach ($option->childrenCategories as $row)
                                                    <div class="@if ($option->select_type == 1) size__checkbox @else size__radio @endif">
                                                        <input data-amount="{{ $row->amount }}"
                                                            data-amounttype="{{ $row->amount_type }}" @if ($option->select_type == 1) type="checkbox" @else type="radio" @endif name="option[]" value="{{ $row->id }}"
                                    ...
                                    <p class="text-danger none required_option">
                                        {{ __('Please Select A Option From Required Field') }}</p>
                                    <div class="pd-detail-inline-2">
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            <div class="input-counter">
                                                ...
                                                <input name="qty" id="qty"
                                                    ...
                                                    type="text" @if ($info->stock->stock_manage == 1)  @if ($info->stock->stock_status==0) disabled
                                            data-max="0" data-min="0" @else
                                                data-max="{{ $info->stock->stock_qty }}" data-min="1"
                                        ...
                                        <div class="u-s-m-b-15">
                                            <button class="btn btn--e-brand-b-2 submit_btn" @if ($info->stock->stock_status == 0) disabled @endif type="submit">
                                                @if ($info->stock->stock_status == 0)
                                                <del>{{ __('Out Of Stock') }}</del> @else {{ __('Add to Cart') }}
                                                @endif
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pd-tab__rev">
                                        ...
                                        <div class="u-s-m-b-30">
                                            <div class="rev-f1__group">
                                                <div class="u-s-m-b-15">
                                                    <h2><span class="review_count"></span> {{ __('Review(s) for') }}
                                                        {{ $info->title }}</h2>
                                                </div>
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <form class="pd-tab__rev-f2 review-form" method="post"
                                                ...
                                                <span
                                                    class="gl-text u-s-m-b-15">{{ __('Your email address will not be published. Required fields are marked') }}
                                                    *</span>
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="u-s-m-b-30">
                                                            ...
                                                            <input class="input-text input-text--primary-style" type="email"
                                                                id="reviewer-email" name="email" placeholder="Your email"
                                                                required readonly
                                                ...
                                                <div>
                                                    @if (Auth::guard('customer')->check())
                                                        <button class="btn btn--e-brand-shadow review_btn" type="submit"><i
                                                                class="fas fa-paper-plane"></i>
                                                            {{ __('Send Review') }}</button>
                                                    @else
