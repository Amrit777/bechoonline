                            ...
                            <div id="checkout-msg-group">
                                @if (env('MULTILEVEL_CUSTOMER_REGISTER') == true && !Auth::guard('customer')->check())
                                    ...
                                    <div class="msg u-s-m-b-30">
                                        <span class="msg__text">{{ __('Returning customer?') }}
                                            <a class="gl-link" href="#return-customer"
                                                data-toggle="collapse">{{ __('Click here to login') }}</a></span>
                                        @error('email')
                                        ...
                                        <div class="collapse" id="return-customer" data-parent="#checkout-msg-group">
                                            <div class="l-f u-s-m-b-16">
                                                <span
                                                    class="gl-text u-s-m-b-16">{{ __('If you have an account with us, please log in.') }}</span>
                                                <form class="l-f__form" action="{{ url('/customer/login') }}"
                                                    method="post">
                                                    @csrf
                                                    <div class="gl-inline">
                                                        <div class="u-s-m-b-15">
                                                            <label class="gl-label" for="login-email">{{ __('E-mail') }}
                                                                *</label>
                                                            <input class="input-text input-text--primary-style" name="email"
                                                                type="text" id="login-email" placeholder="Enter E-mail">
                                                        ...
                                                        <div class="u-s-m-b-15">
                                                            ...
                                                            <input class="input-text input-text--primary-style"
                                                                name="password" type="password" id="login-password"
                                                    ...
                                                    <div class="gl-inline">
                                                        ...
                                                        <div class="u-s-m-b-15">
                                                            <a class="gl-link"
                                                                href="{{ url('/user/password/reset') }}">{{ __('Lost Your Password?') }}</a>
                                                        </div>
                                                    </div>
                                                    <!--====== Check Box ======-->
                                                    <div class="check-box">
                                ...
                                <div class="msg">
                                    <span class="msg__text">{{ __('Have a coupon?') }}
                                        <a class="gl-link"
                                            href="{{ url('/cart') }}">{{ __('Click Here to enter your code') }}</a></span>
                                    ...
                                    <div class="u-s-m-b-30">
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            <input type="text" placeholder="Full Name" name="name"
                                                class="input-text input-text--primary-style" required=""
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            <input class="input-text input-text--primary-style" name="phone" required
                                        ...
                                        @if (domain_info('shop_type') == 1)
                                            ...
                                            @if (count($locations) > 0)
                                                ...
                                                <div class="u-s-m-b-15">
                                                    <!--====== Select Box ======-->
                                                    <label class="gl-label" for="billing-country">{{ __('Location') }}
                                                        *</label>
                                                    <select class="select-box select-box--primary-style location"
                                                        name="location" id="billing-country" data-bill="">
                                                        <option selected disabled value="">{{ __('Select Location') }}
                                                        </option>
                                                        @foreach ($locations as $location)
                                                            <option value="{{ $location->id }}"
                                                                data-method="{{ $location->child_relation }}">
                                            ...
                                            <div class="u-s-m-b-15">
                                                <label class="gl-label"
                                                    for="billing-town-city">{{ __('Delivery Address') }} *</label>
                                                <input class="input-text input-text--primary-style"
                                                    placeholder="Delivery Address" name="delivery_address" required
                                                    type="text" id="billing-town-city" data-bill="">
                                            </div>
                                            <!--====== End - Town / City ======-->
                                            <div class="u-s-m-b-15">
                                                <label class="gl-label" for="billing-town-zip">{{ __('Zip Code') }}
                                                    *</label>
                                                <input class="input-text input-text--primary-style" type="number"
                                                    placeholder="Zip Code" name="zip_code" required id="billing-town-zip"
                                                    data-bill="">
                                            </div>
                                        @endif
                                        ...
                                        @if (env('MULTILEVEL_CUSTOMER_REGISTER') == true && !Auth::guard('customer')->check())
                                            ...
                                            <div class="u-s-m-b-10">
                                                <div class="check-box">
                                                    <input type="checkbox" id="make-default-address" name="create_account"
                                                        value="1" class="create_account" data-bill="">
                                                    <div class="check-box__state check-box__state--primary">
                                                        <label class="check-box__label create_account"
                                                            for="make-default-address">{{ __('Want to create a new account?') }}
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="u-s-m-b-15 none password_area" id="create-account">
                                                <span
                                                    class="gl-text u-s-m-b-15">{{ __('Create an account by entering the information below. If you are a returning customer please login at the top of the page.') }}</span>
                                                <div>
                                                    <label class="gl-label"
                                                        for="reg-password">{{ __('Account Password') }} *</label>
                                                    <input class="input-text input-text--primary-style" type="password"
                                                        name="password" data-bill id="reg-password">
                                                </div>
                                            </div>
                                        ...
                                        <div class="u-s-m-b-10">
                                            <label class="gl-label"
                                                for="order-note">{{ __('Order Note :') }}</label><textarea
                                                class="text-area text-area--primary-style" name="comment"
                                                        ...
                                                        <div class="o-card__flex">
                                                            ...
                                                            <div class="o-card__info-wrap">
                                                                <span class="o-card__name">
                                                                    <a
                                                                        href="{{ url('/product/' . $row->name . '/' . $row->id) }}">{{ $row->name }}
                                                                        x {{ $row->qty }} </a>
                                                    ...
                                                    <div class="u-s-m-b-10">
                                                        ...
                                                        <div class="radio-box">
                                                            <input type="radio" id="payment_method_{{ $key }}"
                                                                name="payment_method" value="{{ $row->category_id }}" @if ($key == 0) checked="checked" @endif>
