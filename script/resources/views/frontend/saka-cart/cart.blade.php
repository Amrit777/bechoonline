                                    ...
                                    <tbody>
                                        @foreach (Cart::content() as $row)
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="table-p__box">
                                                        ...
                                                        <div class="table-p__info">
                                                            <span class="table-p__name">
                                                                <a
                                                                    href="{{ url('/product/' . $row->name . '/' . $row->id) }}">{{ Str::limit($row->name, 70) }}</a></span>
                                                            <span class="table-p__category">
                                                                <a
                                                                    href="{{ url('/product/' . $row->name . '/' . $row->id) }}"></a>
                                                ...
                                                <td>
                                                    <span class="table-p__price">{{ amount_format($row->price) }} x
                                                        {{ $row->qty }} </span>
                                                </td>
                                                <td>
                                                    <span
        ...
        <div class="u-s-p-b-60">
            ...
            <div class="section__content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 u-s-m-b-30">
                            <form class="f-cart basicform_with_reload" enctype="multipart/form-data"
                                    ...
                                    <div class="col-lg-6 col-md-6 u-s-m-b-30">
                                        <div class="f-cart__pad-box">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" name="code" type="text"
                                                    id="coupon_code" placeholder="Coupon code" required="">
                                            </div>
                                            <div class="u-s-m-b-30">
                                                <button
                                                    class="f-cart__ship-link btn--e-transparent-brand-b-2 btn basicbtn">{{ __('Apply coupon') }}</button>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 u-s-m-b-30">
                                <div class="f-cart__pad-box">
                                    ...
                                    <div>
                                        <a href="{{ url('/checkout') }}"
                                            class="btn btn--e-brand-b-2">{{ __('Proceed to checkout') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
