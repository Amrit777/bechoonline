        ...
        <div class="col-md-8 order-md-1">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation basicform" novalidate method="post"
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="d-block my-3">
                                    @foreach ($posts as $key => $item)
                                        ...
                                        <label for="getway{{ $key }}"><input type="radio" name="payment_method"
                                                id="getway{{ $key }}" value="{{ $item->category_id }}">
                                            {{ $data->title }}</label>
                                        <br>
