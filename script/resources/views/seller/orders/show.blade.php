        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card-body desktop display-desktop-table">
                <ul class="list-group list-group-lg list-group-flush list">
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center">
                            <div class="col-9 text-right">GST({{ tax() }}%)</div>
            ...
            <div class="card-footer">
                ...
                <div class="text-right">
                    ...
                    <form method="POST" action="{{ route('seller.order.update', $info->id) }}" accept-charset="UTF-8"
                        ...
                        <div class="btn-group">
                            <select class="form-control" name="payment_status">
                                ...
                                <option value="1" @if ($info->payment_status == '1') selected="" @endif>{{ __('Payment Complete') }}
                                </option>
                                <option value="2" @if ($info->payment_status == '2') selected="" @endif>{{ __('Payment Pending') }}
                                </option>
                                <option value="0" @if ($info->payment_status == '0') selected="" @endif>{{ __('Payment Cancel') }}
                                </option>
                                <option value="3" @if ($info->payment_status == '3') selected="" @endif>{{ __('Payment Incomplete') }}
                                </option>
                            </select>
                            &nbsp&nbsp
                            <select class="form-control" name="status">
                                <option disabled=""><b>{{ __('Select Order Status') }}</b></option>
                                <option value="pending" @if ($info->status == 'pending') selected="" @endif>{{ __('Awaiting processing') }}
                                </option>
