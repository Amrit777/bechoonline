                            ...
                            <div class="card-body">
                                <div class="row">
                                                    ...
                                                    <div class="selectgroup w-100">
                                                        @foreach ($item as $row)
                                                            <label class="selectgroup-item">
                                                                <input type="radio"
                                                                    name="variation[{{ $row->category_id }}]"
                                                                    value="{{ $row->variation->id }}"
                                                                    class="selectgroup-input">
                                                                <span
                                                                    class="selectgroup-button">{{ $row->variation->name }}</span>
                                                            </label>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="selectgroup w-100">
                                                        @foreach ($option->childrenCategories as $row)
                                                            <label class="selectgroup-item">
                                                                <input @if ($option->select_type == 1) type="checkbox" name="option[]"  @else type="radio" name="option[{{ $key }}]" @endif value="{{ $row->id }}"
                                                                    class="selectgroup-input
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <p class="exp_area none">{{ __('Checkout Url') }}: <span
                                                class="express_url text-primary"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
