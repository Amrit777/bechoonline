            ...
            <div class="row mb-2">
                <div class="col-lg-8">
                    ...
                    <div class="products-finalised-status">
                        <a href="{{ route('seller.product.list', 1) }}" class="mr-2 btn btn-outline-success @if ($type==1) active @endif">{{ __('Publish') }}
                            ({{ $actives }})</a>

                        <a href="{{ route('seller.product.list', 2) }}" class="mr-2 btn btn-outline-info @if ($type==2) active @endif">{{ __('Draft') }}
                            ({{ $drafts }})</a>

                        <a href="{{ route('seller.product.list', 3) }}" class="mr-2 btn btn-outline-warning @if ($type==3) active @endif">{{ __('Incomplete') }}
                            ({{ $incomplete }})</a>
                ...
                <div class="col-lg-4">
                    <div class="add-import">
                        <a href="#" class="btn btn-info float-right mr-3" data-toggle="modal"
                            data-target="#import">{{ __('Import') }}</a>
                            ...
                            @foreach ($posts as $row)
                                <tr id="row{{ $row->id }}">
                                    ...
                                    <td>{{ $row->title }} (#{{ $row->id }})
                                        <div>
                                            <a
                                                href="{{ route('seller.product.edit', $row->id) }}">{{ __('Edit') }}</a>
                                            |
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('seller.products.import') }}" method="POST" class="basicform"
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="import_area">
                            <div>
                                <p class="text-left"><a
                                        href="{{ asset('uploads/demo.csv') }}">{{ __('Download Sample') }}</a>
                                </p>
                            </div>
