                            ...
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#contact4" role="tab"
                                        aria-controls="contact" aria-selected="false">Other</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <form method="post" action="{{ route('seller.settings.store') }}" class="basicform">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="store_email" class="form-control" required=""
                                                placeholder="reply@example.com" value="{{ $store_email->value ?? '' }}">
                                        </div>

                                        <div class="form-group">
                                            <label>Order ID Format (Prefix)</label>
                                            <input type="text" name="order_prefix" class="form-control" required=""
                                                placeholder="#ABC" value="{{ $order_prefix->value ?? '' }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="currency_name" class="form-control" required=""
                                                placeholder="USD" value="{{ $currency->currency_name ?? '' }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Currency Icon</label>
                                            <input type="text" name="currency_icon" class="form-control" required=""
                                                placeholder="$" value="{{ $currency->currency_icon ?? '' }}">
                                        </div>
                                        {{-- amit singh starts --}}
                                        <div class="form-group">
                                            <label>GST</label>
                                            <input type="text" name="tax" class="form-control" required=""
                                                placeholder="0.00" value="{{ $tax->value ?? '' }}">
                                        </div>
                                        <div class="form-group">
                                            <label>GSTIN</label>
                                            <input type="text" name="gstin" class="form-control" placeholder="GSTIN Number"
                                                value="{{ $gstin->value ?? '' }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Minimum Amount Delivery</label>
                                            <input type="text" name="min_delivery_amt" class="form-control"
                                                placeholder="Minimum Amount Delivery"
                                                value="{{ $min_delivery_amt->value ?? '' }}">
                                        </div>
                                        {{-- amit singh ends --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_receive_method">
                                                <option value="whatsapp" @if ($order_receive_method == 'whatsapp') selected="selected" @endif>
                                                    {{ __('I will Receive My Order Via Whatsapp') }}</option>
                                                <option value="email" @if ($order_receive_method == 'email') selected="selected" @endif>
                                    ...
                                    <form method="post" action="{{ route('seller.settings.store') }}" class="basicform">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="company_name"
                                                value="{{ $location->company_name ?? '' }}" type="text" value=""
                                                required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input class="form-control" name="address"
                                                value="{{ $location->address ?? '' }}" type="text" value="" required="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" type="email"
                                                value="{{ $location->email ?? '' }}" value="" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input class="form-control" name="phone" type="number"
                                                value="{{ $location->phone ?? '' }}" value="" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice Description</label>
                                            <textarea class="form-control"
                                                name="invoice_description">{{ $location->invoice_description ?? '' }}</textarea>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="pwa" role="tabpanel" aria-labelledby="profile-tab4">
                                    <form method="post" action="{{ route('seller.settings.store') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="app_icon_128x128" type="file" required=""
                                                accept="image/.png">

                                        </div>
                                        <div class="form-group">
                                            <label>App Icon 144x144</label>
                                            <input class="form-control" name="app_icon_144x144" type="file" required=""
                                                accept="image/.png">

                                        </div>
                                        <div class="form-group">
                                            <label>App Icon 152x152</label>
                                            <input class="form-control" name="app_icon_152x152" type="file" required=""
                                                accept="image/.png">

                                        </div>
                                        <div class="form-group">
                                            <label>App Icon 192x192</label>
                                            <input class="form-control" name="app_icon_192x192" type="file" required=""
                                                accept="image/.png">

                                        </div>
                                        <div class="form-group">
                                            <label>App Icon 512x512</label>
                                            <input class="form-control" name="app_icon_512x512" type="file" required=""
                                                accept="image/.png">

                                        </div>
                                        <div class="form-group">
                                            <label>App Icon 256x256</label>
                                            <input class="form-control" name="app_icon_256x256" type="file" required=""
                                                accept="image/.png">
                                    ...
                                    <form method="post" action="{{ route('seller.settings.store') }}" class="basicform"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="theme_color" class="form-control rgcolorpicker"
                                                required="" value="{{ $theme_color->value ?? '' }}">
                                        </div>
