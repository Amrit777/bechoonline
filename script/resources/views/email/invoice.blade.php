                        ...
                        <tr>
                            <td class="title">
                                <img height="80" width="160"
                                    src="{{ asset('uploads/' . $order->user_id . '/logo.png') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                @if (!empty($location))
                                    ...
                                    {{ $location->zip_code }}, {{ $location->address }}, {{ $location->city }},
                                    {{ $location->state }}<br>
            ...
            <table class="item">
                <tbody>
                    ...
                    @foreach ($order->order_item as $key => $orderitem)
                        <tr>
                            <td class="text-left">{{ $orderitem->term->title }}
                                ...
                                @endphp
                                @if (count($variations->attribute) > 0 || count($variations->options) > 0)
                                @endif
                            ...
                            <td class="text-center">{{ amount_format($orderitem->amount) }} x
                                {{ $orderitem->qty }}</td>
                    ...
                    <tr>
                        {{-- amit singh --}}
                        <td></td>
                        <td class="text-right"><strong>GST({{ $order->gst }}%):</strong></td>
                        <td class="text-right">{{ amount_format($order->tax) }}</td>
                    </tr>
                    @if ($order->order_type == 1)
                        <tr>
