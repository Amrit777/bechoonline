                        ...
                        <div class="card-stats-title">{{ __('Order Statistics') }} -
                            <div class="dropdown d-inline">
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm">
                                    ...
                                    <li><a href="#" class="dropdown-item month @if (Date('F')=='May'
                                            ) active @endif"
                                            data-month="May">{{ __('May') }}</a></li>
                                    <li><a href="#" class="dropdown-item month @if (Date('F')=='June'
                                            ) active @endif"
                                            data-month="June">{{ __('June') }}</a></li>
                                    <li><a href="#" class="dropdown-item month @if (Date('F')=='July'
                                            ) active @endif"
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            @foreach ($request_users as $row)
                                <li class="media">
                                    <a href="{{ route('admin.customer.show', $row->id) }}"><img
                                            class="mr-3 rounded-circle" width="50"
                                            src="https://ui-avatars.com/api/?name={{ $row->name }}&background=random"
                                            alt="avatar"></a>
                                    <div class="media-body">
                                        <div class="float-right text-primary mt-3"><a
                                                href="{{ route('admin.customer.show', $row->id) }}">{{ $row->created_at->diffForHumans() }}</a>
                                        </div>
                                        <div class="media-title  mt-3"><a
                                                href="{{ route('admin.customer.show', $row->id) }}">{{ $row->name }}</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                                ...
                                <tbody class="list font-size-base rowlink" data-link="row">
                                    @foreach ($orders ?? [] as $key => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('admin.customer.show', $row->user->id) }}">{{ $row->user->name }}</a>
                                            </td>
                                            ...
                                            <td>
                                                @if ($row->status == 1) <span
                                                    class="badge badge-success">Approved</span> @elseif($row->status
                                                    ==
                                                    2) <span
                                                    class="badge badge-warning">{{ __('Pending') }}</span>@elseif($row->status
                                                    == 3) <span
                                                    class="badge badge-danger">{{ __('Expired') }}</span>@else
